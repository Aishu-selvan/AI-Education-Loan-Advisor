...
URL = "https://www.hdfc.bank.in/education-loan/central-government-interest-subsidy-scheme?icid=website_organic_listcards_choosetherighteducationloanforyourfuture:link:knowmore"
...
with open("cgiss.html", "w", encoding="utf-8") as f:
...
output = {
    "bank": "HDFC Bank",
    "loan_scheme": "Central Government Interest Subsidy Scheme",
    "url": URL,
    "sections": sections,
}
...
print("Saved to Data/raw/hdfc_cgiss.json")
